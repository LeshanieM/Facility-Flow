...
const NotificationPage = () => {
  ...
  const getIcon = (type) => {
    switch (type) {
      ...
      case 'TICKET':
        return <Ticket className="text-amber-500" size={18} />;
      case 'COMMENT':
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 font-medium mt-1">
              Manage your campus alerts and updates
            </p>
          </div>
        </div>
          ...
          {loading ? (
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start mb-1">
                    <div>
                      <h3
                        className={`text-base font-bold ${!notification.read ? 'text-slate-900' : 'text-slate-600'}`}
                      >
                        {notification.title}
                      </h3>
                  ...
                  <p
                    className={`text-sm mt-2 leading-relaxed ${!notification.read ? 'text-slate-500' : 'text-slate-400'}`}
                  >
            ...
            <div className="py-24 text-center">
              ...
              <p className="text-slate-500 mt-2 mb-6">
                You're all caught up with campus updates!
              </p>
            </div>
          )}
        </div>
