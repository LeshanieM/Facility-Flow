...
const FacilityCataloguePage = () => {
    ...
    const loadResources = async () => {
        ...
        try {
            ...
            setError('We encountered an issue communicating with the server. Please check your connection and try again.');
        } finally {
            setLoading(false);
        }
    };
        ...
        <Layout>
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div className="mb-8">
                    ...
                    <p className="text-slate-500 mt-2 ml-16 font-medium">Browse and search available campus facilities and resources.</p>
                </div>

                <ResourceFilter filters={filters} setFilters={setFilters} onSearch={loadResources} />
                ...
                {loading ? (
                    ...
                    <div className="text-center py-24 bg-rose-50 rounded-3xl border border-rose-100 shadow-sm animate-fade-in">
                        ...
                        <button onClick={loadResources} className="mt-6 px-6 py-2.5 bg-white text-rose-600 font-bold rounded-xl border border-rose-200 shadow-sm hover:bg-rose-100 transition-all">Try Again</button>
                    </div>
                ) : resources.length === 0 ? (
                    <div className="text-center py-24 bg-white rounded-3xl border border-slate-100 shadow-sm">
                        ...
                        <p className="text-slate-500 mt-2 font-medium">Try adjusting your search filters to see more results.</p>
                    </div>
                ) : (
